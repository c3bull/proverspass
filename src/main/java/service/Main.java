...
//        System.out.println(data);
    ...
    private static String readFromInputStream(){
        ...
        try {
            File currentDir = new File("C:\\Users\\Kuba\\Desktop\\kompilatory\\kompilatory\\example\\spass\\pelleter_57.spass");
    ...
    private static String readFromInputStreamtwo(){
        StringBuilder resultStringBuilder = new StringBuilder();
        try {
            File currentDir = new File("C:\\Users\\Kuba\\Desktop\\kompilatory\\kompilatory\\example\\prover9\\ergo_sum.prover9");
            Scanner myReader = new Scanner(currentDir );
            while (myReader.hasNextLine()) {
                String data = myReader.nextLine();
                resultStringBuilder.append(data).append("\n");
